...
class RectifiedFlowCtrlPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    r"""
    ...
    def __call__(
        ...
        image: PipelineImageInput = None, # controlnet ctrl
